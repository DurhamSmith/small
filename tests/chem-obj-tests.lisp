...
(test "(apply-transformation tfm v) traverses parents" :report 'interactive)
(define-test "(apply-transformation tfm v) traverses parents"
  (let ((parent (make-instance 'SMALL::chem-obj))
    ...
    (is equal (list (cons "translate" v)
		    (cons "rotate" mat))
	(small::all-tfms child))
    (is-close (v3 0 1 1)
